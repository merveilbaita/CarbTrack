...
urlpatterns = [
    ...
    path("interventions/<int:intervention_id>/status", views.intervention_status, name="api-intervention-status"),
    path("directions", views.directions, name="api-directions"),
